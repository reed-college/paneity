...
class CourseTestCase(TestCase):
    ...
    def test_course_model_has_useful_string(self):
        """
        Makes sure that the course model string function has something to do with the actual
        object. More specififcally, it asserts that either the title or number appears
        in the string.
        """
...
class SubjectTestCase(TestCase):
    ...
    def test_course_model_has_useful_string(self):
        """
        Makes sure that the subject model string function has something to do with the actual
        object. More specififcally, it asserts that either the name or abbreviation appears
        in the string.
        """
