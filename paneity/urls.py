...
urlpatterns = [
    ...
    # This page allows admins to create new users, new courses, new subjects, etc
    url(r'^admin/', admin.site.urls),
    # This redirects to spirit urls
    url(r'^forum/', include('spirit.urls')),
    # This redirects to django private chat urls, and this doesn't interfere with the first url()
